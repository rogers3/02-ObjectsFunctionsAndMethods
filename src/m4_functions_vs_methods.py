...
def try_methods():
    garry = rg.SimpleTurtle('turtle')
    garry.pen=rg.Pen('brown', 5)
    garry.forward(150)
    garry.left(90)
    garry.forward(50)
    garry.backward(100)
...
def try_methods_and_functions():
    ...
    sam.speed = 1
    draw_many_squares(sam, 2, 100, 30)

    sam.speed =5
    sam.pen=rg.Pen('red', 5)
    draw_many_squares(sam, 10, 50, 15)

    sam.speed = 100
    sam.pen = rg.Pen('red', 35)
    draw_many_squares(sam, 8, 300, 60)

    mas = rg.SimpleTurtle('turtle')
    mas.pen = rg.Pen('black', 3)
