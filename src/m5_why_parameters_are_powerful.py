...
def main():
    ...
    # better_draw_circles(rg.Point(0,0), 35)
    # even_better_draw_circles(rg.Point(0,0), 50, 6, 'green', 7)
    # even_better_draw_circles(rg.Point(250, 100), 5, 30, 'red', 1)
    # even_better_draw_circles(rg.Point(50, -150), 15, 9, 'orange', 3)
    even_better_draw_circles(rg.Point(-150, 100), 10, 15, 'black', 3)
    even_better_draw_circles(rg.Point(-150, 100), 15, 10, 'red', 3)
    even_better_draw_circles(rg.Point(150,100), 10, 15, 'black', 3)
    even_better_draw_circles(rg.Point(150, 100), 15, 10, 'red', 3)
